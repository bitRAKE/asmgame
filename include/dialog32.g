...
; TODO: check for duplicate fields, this way balloons the symbol space for a low probality error. Need a "depth" of vectored symbol to easily reject depths>2
;	transform part,?{n}.DLGITEMTEMPLATEEX
;	jyes error_dup
...
more:	arrange rest,
	...
	jno error
	arrange var,part
	transform var,DLGITEMTEMPLATEEX
	jno error
	arrange var,=DLGITEMTEMPLATEEX.part
	publish :var,value
	arrange var,=restore var
	take final,var ; changes made to fields are removed later
