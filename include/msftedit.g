...
;	+ comment out abstracted constants

; not found
;?	EM_SETQUERYCONVERTOLELINKCALLBACK ; {context}, OLESTREAMQUERYCONVERTOLELINKCALLBACK

;define RICHEDIT60_CLASS	"RICHEDIT60W"
;define MSFTEDIT_CLASS		"RICHEDIT50W" ; Windows 10+
...
if 0 ; user32 edit control constants
; Edit control messages

EM_GETSEL	       = 00B0h
EM_SETSEL	       = 00B1h
EM_GETRECT	       = 00B2h ; 0, RECT
EM_SETRECT	       = 00B3h ;{?}, RECT
;EM_SETRECTNP	       = 00B4h ;{?}, RECT
EM_SCROLL	       = 00B5h
EM_LINESCROLL	       = 00B6h
...
EM_FINDTEXT		:= WM_USER + 56 ; FR_*, FINDTEXT
...
EM_SETBKGNDCOLOR	:= WM_USER + 67 ; bool {system color}, COLOREF {optional}
EM_SETCHARFORMAT	:= WM_USER + 68 ; SCF_*, CHARFORMAT
	SCF_DEFAULT		:= 0000h
	SCF_SELECTION		:= 0001h
	SCF_WORD		:= 0002h
	SCF_ALL			:= 0004h
	SCF_USEUIRULES		:= 0008h
	SCF_ASSOCIATEFONT	:= 0010h
	SCF_NOKBUPDATE		:= 0020h
	SCF_ASSOCIATEFONT2	:= 0040h
	SCF_SMARTFONT		:= 0080h
	SCF_CHARREPFROMLCID	:= 0100h
;?
	SPF_DONTSETDEFAULT	:= 0002h
	SPF_SETDEFAULT		:= 0004h

EM_SETEVENTMASK		:= WM_USER + 69 ; 0, ENM_*
	ENM_NONE		:= 00000000h
...
EM_SETOLECALLBACK	:= WM_USER + 70 ; 0, IRichEditOleCallback
EM_SETPARAFORMAT	:= WM_USER + 71 ; 0, PARAFORMAT2
EM_SETTARGETDEVICE	:= WM_USER + 72 ; hDC, {line width}
EM_STREAMIN		:= WM_USER + 73
EM_STREAMOUT		:= WM_USER + 74
EM_GETTEXTRANGE		:= WM_USER + 75
EM_FINDWORDBREAK	:= WM_USER + 76 ; WB_*, {start}
	WB_LEFT		:=0
	WB_RIGHT	:=1
	WB_ISDELIMITER	:=2
	WB_CLASSIFY 	:=3
...
EM_SETOPTIONS		:= WM_USER + 77 ; ECOOP_*, ECO_* ; similar to ES_* styles
...
EM_FINDTEXTEX		:= WM_USER + 79 ; FR_*, FINDTEXTEX

EM_GETWORDBREAKPROCEX	:= WM_USER + 80
EM_SETWORDBREAKPROCEX	:= WM_USER + 81 ; 0, EditWordBreakProcEx
	WBF_CLASS	:= 0Fh
	WBF_ISWHITE	:= 10h
	WBF_BREAKLINE	:= 20h
	WBF_BREAKAFTER	:= 40h

EM_SETUNDOLIMIT		:= WM_USER + 82 ; {number of action}, 0
EM_REDO			:= WM_USER + 84
EM_CANREDO		:= WM_USER + 85
EM_GETUNDONAME		:= WM_USER + 86
EM_GETREDONAME		:= WM_USER + 87
EM_STOPGROUPTYPING	:= WM_USER + 88
EM_SETTEXTMODE		:= WM_USER + 89 ; TM_*, 0
...
EM_AUTOURLDETECT	:= WM_USER + 91 ; AURL_*, {url schemes : optional}
	AURL_ENABLEURL			:= 01h
...
EM_SETPALETTE		:= WM_USER + 93 ; hPalette, 0
EM_GETTEXTEX		:= WM_USER + 94
EM_GETTEXTLENGTHEX	:= WM_USER + 95
EM_SHOWSCROLLBAR	:= WM_USER + 96
EM_SETTEXTEX		:= WM_USER + 97 ; SETTEXTEX, *str

EM_SETPUNCTUATION	:= WM_USER + 100 ; PC_, PUNCTUATION
...
EM_SETWORDWRAPMODE	:= WM_USER + 102 ; WBF_*, 0
...
EM_SETIMECOLOR		:= WM_USER + 104 ; 0, COMPCOLOR
EM_GETIMECOLOR		:= WM_USER + 105

EM_SETIMEOPTIONS	:= WM_USER + 106 ; ECOOP_, IMF_
...
EM_SETLANGOPTIONS	:= WM_USER + 120 ; 0, IMF_
...
EM_FINDTEXTW		:= WM_USER + 123 ; FR_*, FINDTEXTW
EM_FINDTEXTEXW		:= WM_USER + 124 ; FR_*, FINDTEXTEXW
...
EM_SETIMEMODEBIAS	:= WM_USER + 126 ; IMF_*, IMF_* ; same!
	IMF_SMODE_PLAURALCLAUSE	:= 1
	IMF_SMODE_NONE		:= 2

EM_GETIMEMODEBIAS	:= WM_USER + 127

EM_SETBIDIOPTIONS	:= WM_USER + 200 ; 0, BIDIOPTIONS
...
EM_SETEDITSTYLE		:= WM_USER + 204 ; SES_* {set}, SES_* {mask}
...
EM_SETSCROLLPOS		:= WM_USER + 222 ; 0, POINT

EM_SETFONTSIZE		:= WM_USER + 223 ; {point size change}, 0

EM_GETZOOM		:= WM_USER + 224
EM_SETZOOM		:= WM_USER + 225 ; numerator, denominator
...
EM_SETHYPHENATEINFO	:= WM_USER + 231 ; HYPHENATEINFO, 0

EM_INSERTTABLE		:= WM_USER + 232

EM_GETAUTOCORRECTPROC	:= WM_USER + 233
EM_SETAUTOCORRECTPROC	:= WM_USER + 234 ; AutoCorrectProc, 0
EM_CALLAUTOCORRECTPROC	:= WM_USER + 255 ; ?U+0009, 0
	ATP_NOCHANGE		:= 0
	ATP_CHANGE		:= 1
	ATP_NODELIMITER		:= 2
...
EM_SETPAGEROTATE	:= WM_USER + 236 ; ERR_*, 0
	EPR_0	:= 0
	EPR_270	:= 1
	EPR_180	:= 2
	EPR_90	:= 3
...
EM_SETCTFMODEBIAS	:= WM_USER + 238 ; CTFMODEBIAS_*, 0
...
EM_SETCTFOPENSTATUS	:= WM_USER + 241 ; bool {open keyboard}, 0
...
EM_SETEDITSTYLEEX	:= WM_USER + 275 ; SES_EX_* {set}, SES_EX_* {mask}
...
EM_SETSTORYTYPE		:= WM_USER + 291 ; {index}, tom*Story

EM_GETELLIPSISMODE	:= WM_USER + 305
EM_SETELLIPSISMODE	:= WM_USER + 306 ; 0, ELLIPSIS_*

EM_SETTABLEPARMS	:= WM_USER + 307 ; TABLEROWPARMS, TABLECELLPARMS

EM_GETTOUCHOPTIONS	:= WM_USER + 310
EM_SETTOUCHOPTIONS	:= WM_USER + 311 ; RTO_*, bool {enable handles}

EM_INSERTIMAGE 		:= WM_USER + 314

EM_SETUIANAME		:= WM_USER + 320 ; 0, *str

EM_GETELLIPSISSTATE	:= WM_USER + 322

EM_SETQUERYCONVERTOLELINKCALLBACK	:= WM_USER + 403 ; ?
EM_SETDISABLEOLELINKCONVERSION		:= WM_USER + 404 ; 0, bool {disable}


;ECM_FIRST := 0x1500 ; Edit control messages
EM_SETCUEBANNER		:= ECM_FIRST + 1	; bool {focus}, *{du}
EM_GETCUEBANNER		:= ECM_FIRST + 2
EM_SHOWBALLOONTIP	:= ECM_FIRST + 3
EM_HIDEBALLOONTIP	:= ECM_FIRST + 4
;EM_SETHILITE		:= ECM_FIRST + 5	; not implemented
;EM_GETHILITE		:= ECM_FIRST + 6	; not implemented
;EM_NOSETFOCUS		:= ECM_FIRST + 7	; internal
;EM_TAKEFOCUS		:= ECM_FIRST + 8	; internal
EM_SETEXTENDEDSTYLE	:= ECM_FIRST + 9	; {mask}, {SESE_EX_*}
EM_GETEXTENDEDSTYLE	:= ECM_FIRST + 10	; 0, 0
EM_SETENDOFLINE		:= ECM_FIRST + 11	; EC_*, 0
EM_GETENDOFLINE		:= ECM_FIRST + 12	; 0, 0
EM_ENABLESEARCHWEB	:= ECM_FIRST + 13	; bool, 0
EM_SEARCHWEB		:= ECM_FIRST + 14	; 0, 0
EM_SETCARETINDEX	:= ECM_FIRST + 15	; {index}, 0
EM_GETCARETINDEX	:= ECM_FIRST + 16	; 0, 0
EM_FILELINEFROMCHAR	:= ECM_FIRST + 17	; {index}, 0
EM_FILELINEINDEX	:= ECM_FIRST + 18	; {line}, 0
EM_FILELINELENGTH	:= ECM_FIRST + 19	; {index}, 0
EM_GETFILELINE		:= ECM_FIRST + 20	; {line}, *{buffer}
EM_GETFILELINECOUNT	:= ECM_FIRST + 21	; 0, 0
...
EN_MSGFILTER		:=0700h	; MSGFILTER
EN_REQUESTRESIZE	:=0701h ; REQRESIZE
	struct REQRESIZE
		nmhdr NMHDR
		rc RECT
	ends

EN_SELCHANGE		:=0702h	; SELCHANGE
EN_DROPFILES		:=0703h
EN_PROTECTED		:=0704h	; ENPROTECTED
EN_CORRECTTEXT		:=0705h
EN_STOPNOUNDO		:=0706h	; NMHDR, cancel undo?
EN_IMECHANGE		:=0707h
EN_SAVECLIPBOARD	:=0708h	; ENSAVECLIPBOARD
EN_OLEOPFAILED		:=0709h
EN_OBJECTPOSITIONS	:=070Ah
EN_LINK			:=070Bh	; ENLINK
EN_DRAGDROPDONE		:=070Ch
EN_PARAGRAPHEXPANDED	:=070Dh	; NMHDR
EN_PAGECHANGE		:=070Eh
EN_LOWFIRTF		:=070Fh	; ENLOWFIRTF
EN_ALIGNLTR		:=0710h
EN_ALIGNRTL		:=0711h
EN_CLIPFORMAT		:=0712h
EN_STARTCOMPOSITION	:=0713h
EN_ENDCOMPOSITION	:=0714h ; ENDCOMPOSITIONNOTIFY

struct ENDCOMPOSITIONNOTIFY, packed
	nmhdr	NMHDR
	dwCode	dd ? ; ECN_*
ends
...
SF_RTFNOOBJS		=0003h
SF_TEXTIZED		=0004h
SF_UNICODE		=0010h	; UCS2
SF_USECODEPAGE		=0020h	; highword is codepage
SF_NCRFORNONASCII	=0040h	; \uN for nonASCII
SFF_WRITEXTRAPAR	=0080h	; \par at end
SF_RTFVAL		=0700h	; 3-bit field, value of N - 1 to use for \rtfN or \pwdN
SFF_PWD			=0800h	; Pocket Word format
SFF_KEEPDOCINFO		=1000h	;
SFF_PERSISTVIEWSCALE	=2000h	; persist \viewscaleN control word
;SFF_PLAINRTF		=4000h
SFF_SELECTION		=8000h	; limit EM_STREAMIN/EM_STREAMOUT to selection
...
NE_ENTERTOPLEVELCALLMGR	:=0x0001
NE_EXITTOPLEVELCALLMGR	:=0x0002
NE_CALLMGRSELCHANGE	:=0x0004
NE_CALLMGRCHANGE	:=0x0008
NE_LAYOUTCHANGE		:=0x0010
NE_MODEBIASCHANGE	:=0x0020


EM_PRI_MSG		:= WM_USER + 0x07000
EM_INSERTOBJ		:= EM_PRI_MSG + 0
EM_SETCALLBACK		:= EM_PRI_MSG + 1
EM_SETUPNOTIFY		:= EM_PRI_MSG + 2
EM_GETDOCFLAGS		:= EM_PRI_MSG + 3
EM_SETUIM		:= EM_PRI_MSG + 4
EM_GETPARATXTFLOW	:= EM_PRI_MSG + 5

; Bit fields for EM_GETDOCFLAGS
GDF_READONLY	:=0x0001
GDF_OVERTYPE	:=0x0002
GDF_SINGLECPG	:=0x0004
GDF_RICHTEXT	:=0x0008
GDF_ALL 	:=0x000F

; Option for EM_SETUIM
SES_USEAIMM11	:=0x0001
SES_USEAIMM12	:=0x0002


struct ALTDISPLAYATTRIBUTE
	crText	dd ?	; COLORREF
	crBk	dd ?	; COLORREF
	crLine	dd ?	; COLORREF
	lsStyle	dw ?
